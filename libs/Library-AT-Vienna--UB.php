...
$wgAuthorLink = 'http://aleph.univie.ac.at/F/?func=find-b&request=$utf8_author&find_code=WPE';
...
$wgTitleLink = 'http://aleph.univie.ac.at/F/?func=find-b&request=$utf8_title&find_code=WTI';
...
$wgISBNLink = 'http://aleph.univie.ac.at/F/?func=find-b&request=$isbn&find_code=IBN';

# Define the Links and the corresponding URLs next to an ISBN-tag.
# Use $isbn as a placeholder for the ISBN.
# Use $self as a placeholder for the URL to the bibliography.
$wgISBNLinkTags		= array (
	array ("href" =>  Title::makeTitle(NS_SPECIAL, "Bibliography")->getLocalURL('action=allcopies&isbn=$isbn'),
		   "target" => "aleph",
		   "text" => "UBW"),
