...
$wgAuthorLink = 'http://catalog.loc.gov/cgi-bin/Pwebrecon.cgi?Search_Arg=$surname,+$firstname_normalized$&Search_Code=NAME_&CNT=25';
...
$wgISBNLink = 'http://catalog.loc.gov/cgi-bin/Pwebrecon.cgi?Search_Arg=$isbn&Search_Code=STNO&CNT=10';
